// src/assets/components/Latihan5.jsx
...
export default function Latihan5() {
  return (
    <section className="border-2 border-gray-200 rounded-lg p-4 mb-8">
      ...
      <div className="bg-white p-4 border rounded-lg shadow-sm flex items-center space-x-4 max-w-xl">
        ...
        <div>
          ...
          <p className="text-gray-600 text-sm">Deskripsi produk singkat yang menarik perhatian pembeli.</p>
          <div className="mt-2 flex items-center space-x-2">
            <span className="text-lg font-semibold text-gray-900">Rp 120.000</span>
            <button className="ml-4 px-3 py-1 bg-blue-600 text-white rounded text-sm">Beli</button>
          </div>
        </div>
      </div>
    </section>
