// src/assets/components/Latihan4.jsx
  ...
  return (
    <section className="border-2 border-gray-200 rounded-lg p-4 mb-8">
      ...
      <div className="text-gray-700 h-[600px] grid grid-cols-1 md:grid-cols-[250px_1fr] grid-rows-[auto_1fr_auto] gap-4">
        ...
        <main className="bg-white border-2 border-dashed p-4 rounded-md overflow-auto">Content area. Letakkan artikel / komponen di sini.</main>
